...
public class CollectionViewIndex: UIControl {
    ...
    public override func drawRect(rect: CGRect) {
        ...
        for indexEntry in indexEntries {
            ...
            case .Text(let indexTitle):
                ...
                CATextLayer.drawInRect(CGRect(x: x, y: round(y, scale: contentScaleFactor), width: width, height: titleHeight))
            case .Bullet:
    ...
    func attributedStringForTitle(title: String) -> NSAttributedString {
        return NSAttributedString(string: title, attributes: [NSFontAttributeName: font, NSForegroundColorAttributeName: UIColor.grayColor()])
    }
